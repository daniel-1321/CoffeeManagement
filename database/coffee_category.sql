...
CREATE TABLE `category` (
  ...
  `cat_name` varchar(45) COLLATE utf8mb4_vietnamese_ci NOT NULL,
  PRIMARY KEY (`cat_id`)
...
INSERT INTO `category` VALUES (1,'Cà Phê'),(2,'Trà'),(3,'Macchiato'),(4,'Thức uống đá xay'),(5,'Thức uống trái cây'),(6,'Khác');
